...
},
{
    ...
    {path:'vendor',component:Vendoroutlet,children:[
            ...
            {path:'my-business-info',component:Aboutmybusiness},
            {path:'my-business-services',component:Myservices},
            ...
            {path:'my-promotions',component:Mypromotions},
            {path:'book-promotion',component:Promotions},
            {path:'my-feedback',component:Reviews},
            {path:'analytics',component:MyClients},
            {path:'my-account',component:Myprofile},
    ]
},
{
